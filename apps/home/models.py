...
class TIPO_PROYECTO(models.Model):
    ...
    def __str__(self):
        return f"{self.TP_CNOMBRE} - {self.TP_CDESCRIPCION}"
...
class UNIDAD_NEGOCIO(models.Model):
    ...
    def __str__(self):
        return f"{self.UN_CCODIGO} - {self.UN_CDESCRIPCION}" 
...
class ETAPA(models.Model):
    ...
    def __str__(self):
        return f"Etapa {self.ET_CCODIGO} - {self.ET_CNOMBRE} "
...
class TAREA_GENERAL(models.Model):
    ...
    TG_CESTADO = models.ForeignKey('ESTADO_TAREA', on_delete=models.CASCADE, verbose_name='Estado de la tarea general')
...
class TAREA_INGENIERIA(models.Model):
    ...
    TI_CESTADO = models.ForeignKey('ESTADO_TAREA', on_delete=models.CASCADE, verbose_name='Estado de la tarea de ingeniería')
...
class ASIGNACION_RECURSO_TAREA_GENERAL(models.Model):
    ...
    ART_COSTO_TOTAL = models.DecimalField(max_digits=20, decimal_places=2, verbose_name='Costo Total', default=0)
...
class ASIGNACION_RECURSO_TAREA_INGENIERIA(models.Model):
    ...
    ART_CANTIDAD = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='Cantidad')
    ART_COSTO_UNITARIO = models.DecimalField(max_digits=10, decimal_places=2, verbose_name='Costo Unitario')
    ART_COSTO_TOTAL = models.DecimalField(max_digits=12, decimal_places=2, verbose_name='Costo Total', default=0)
    ART_FFECHA_ASIGNACION = models.DateTimeField(auto_now_add=True, verbose_name='Fecha de Asignación')
