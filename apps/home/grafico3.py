...
def calcular_reacciones_grafico(L, soportes, cargas):
    R1 = 0
    R2 = 0
...
def graficar_diagrama_cortante(L, soportes, cargas):
    R1, R2 = calcular_reacciones_grafico(L, soportes, cargas)
    
    x = [i * L / 999 for i in range(1000)]
    V = []
...
def calcular_reacciones_grafico2(L, soportes, cargas):
    R1 = 0
    R2 = 0
    M = 0
...
def graficar_diagrama_momento(L, soportes, cargas):
    R1, R2 = calcular_reacciones_grafico2(L, soportes, cargas)
...
graficar_diagrama_momento(L, soportes, cargas)
