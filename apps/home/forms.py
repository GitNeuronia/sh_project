...
class formPROYECTO_CLIENTE(forms.ModelForm):
    class Meta:
        ...
        labels = {
            ...
            'PC_CCODIGO': 'Código de ODT',
            'PC_CNOMBRE': 'Nombre de ODT',
            'PC_CDESCRIPCION': 'Descripción de ODT',
            'PC_CLIDER_TECNICO': 'Líder Técnico',
            'PC_CCATEGORIA': 'Categoría de ODT',
            'PC_CTIPO': 'Tipo de ODT',
